...
def main():
    ...
    # Determine num_workers and pin_memory based on device
    # MPS doesn't support pin_memory and multiprocessing can be problematic on macOS
    use_mps = device.type == 'mps'
    num_workers = 0 if use_mps or device.type == 'cpu' else 1
